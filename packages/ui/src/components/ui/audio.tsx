...
export default function Audio({
  ...
  title = "Audio",
  className = "",
  playIcon = <PlayIcon className="w-5 h-5" />,
  pauseIcon = <PauseIcon className="w-5 h-5" />,
  muteIcon = <MuteIcon className="w-4 h-4" />,
  unmuteIcon = <Volume2Icon className="w-4 h-4" />,
  onPlay,
  onPause,
  onEnded,
  onTimeUpdate,
  ...
  return (
    <div className={`bg-[#FFF0F5] rounded-2xl p-2 w-72 shadow-md ${className}`}>
      <audio
        ref={audioRef}
        src={src}
      ...
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          ...
          <div className="text-[#FF69B4] font-medium text-sm">{title}</div>
        </div>
        <div className="flex items-center gap-2">
          <Button
            variant="ghost"
